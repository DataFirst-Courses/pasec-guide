...
```{r message=FALSE, warning=FALSE}
# Set the path to the working folder — replace with your own path! 
setwd("data/") 
# Load PASEC 2019 Grade 2 dataset 
g2 = read_dta("PASEC2019_Grade2_INT.dta") 
```
...
To encourage and assist non-French speaking users to analyse the rich PASEC data, we have supplied do files that apply English variable and value labels. Place the do file in your C:/pasec_data directory and run it.
